...
public class FragmentPhoto extends BaseFragment implements View.OnClickListener {
    ...
    private static final int MAX_PREVIEW_WIDTH = 1920; //1920
    private static final int MAX_PREVIEW_HEIGHT = 1080; //1080
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            Log.d(TAG, "tamanho:" + width + "   tamanho:" + height);
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        Log.d(TAG, "texture: " + textureViewWidth + "   tamanho:" + textureViewHeight);
        Log.d(TAG, "max texture: " + maxWidth + "   tamanho:" + maxHeight);
        Log.d(TAG, "aspect: " + aspectRatio);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.post_camera).setOnClickListener(this);
