...
public class RangeBar extends View {
    ...
    private RangeBar.OnRangeBarChangeListener mListenerChange;
    private RangeBar.OnRangeBarStopListener mListenerStop;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (newLeftIndex != mLeftIndex || newRightIndex != mRightIndex) {
            ...
            if (mListenerChange != null) {
                mListenerChange.onIndexChangeListener(this, mLeftIndex, mRightIndex);
            }
            if (mListenerStop != null) {
                mListenerStop.onIndexStopListener(this, mLeftIndex, mRightIndex);
            }
    ...
    public void setOnRangeBarStopListener(RangeBar.OnRangeBarStopListener listener) {
        mListenerStop = listener;
    }
    /**
    ...
    public static interface OnRangeBarStopListener {

        public void onIndexStopListener(RangeBar rangeBar, int leftThumbIndex, int rightThumbIndex);
    }
